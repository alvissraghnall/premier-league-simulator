...
public class Team {
  ...
  public Team(String name, String shortName, int overall, int defence, int midfield, int attack) {
    this.name = name;
  ...
  public boolean equals(Object o) {
    ...
    if (overall != team.overall)
      return false;
    if (defence != team.defence)
      return false;
    if (midfield != team.midfield)
      return false;
    if (attack != team.attack)
      return false;
