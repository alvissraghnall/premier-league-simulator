...
public class LeagueTableTest {
  ...
  // Map<Team, LeagueData> teamLeagueDataMap = new LeagueTable(new
  // SimulationApplicationTest().getResults()).generate();
  ...
  // return pointsDiff;
  // } else {
  // int goalDiff = team2Data.getGoalsDifference() -
  // team1Data.getGoalsDifference();
  // if (goalDiff != 0) {
  // return goalDiff;
  // } else {
  ...
  // "Played", "Wins", "Draws", "Losses", "GF", "GA", "GD", "Points", "Form");
  ...
  // team.getName(), teamData.getPlayed(), teamData.getWins(),
  // teamData.getDraws(), teamData.getLosses(), teamData.getGoalsFor(),
  // teamData.getGoalsAgainst(), teamData.getGoalsDifference(),
  // teamData.getPoints(), sb.toString());
