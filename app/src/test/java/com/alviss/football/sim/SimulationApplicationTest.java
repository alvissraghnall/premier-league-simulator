...
public class SimulationApplicationTest {
  ...
  // // System.out.println(rs.getMatch().getHomeTeam().getName() + " " +
  // rs.getMatch().getAwayTeam().getName() + team.getName());
  // if (rs.getMatch().getHomeTeam().equals(team) ||
  // rs.getMatch().getAwayTeam().equals(team)) {
  // count++;
  // } else {
  // // System.out.println(rs.getMatch().getHomeTeam().getName() + "vs" +
  // rs.getMatch().getAwayTeam().getName());
  // }
  // }
  // }
  // System.out.println("Number of results by team " + team.getName() + ": " +
  // count);
  ...
  // if ((mtc.getMatch().getHomeTeam().equals(team1) &&
  // mtc.getMatch().getAwayTeam().equals(team2)) ||
  // (mtc.getMatch().getHomeTeam().equals(team2) &&
  // mtc.getMatch().getAwayTeam().equals(team1))) {
  // count++;
  // }
  // }
  // }
  // System.out.println("Results generated between " + team1.getName() + " and " +
  // team2.getName() + ": " + count);
